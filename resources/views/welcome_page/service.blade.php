<section id="services" class="content py-5" style="background-color: #f8f9fa;">
    <div class="container text-center">
        <div class="mb-5">
            <h2 class="fw-bold">ProsharPOS Services</h2>
            <p class="text-muted" style="max-width: 750px; margin: 0 auto;">
                Discover the exclusive services provided by ProsharPOS to help your business run efficiently,
                stay organized, and delight your customers.
            </p>
        </div>
