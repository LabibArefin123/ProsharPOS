...
@section('content_header')
    <h1 class="m-0 text-dark">Add New Branch</h1>
@endsection
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" step="0.01" name="balance" id="balance"
                        class="form-control @error('balance') is-invalid @enderror" value="{{ old('balance', 0) }}">
                    @error('balance')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="post_code" id="post_code"
                        class="form-control @error('post_code') is-invalid @enderror" value="{{ old('post_code') }}">
                    @error('post_code')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
