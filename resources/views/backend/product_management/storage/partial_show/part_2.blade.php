 ...
 <div class="col-md-4 form-group">
     ...
     <input type="text" id="name" class="form-control" value=" {{ $storage->stock_quantity }}" readonly>
 </div>

 <div class="col-md-4 form-group">
     <strong>Minimum Stock Level:</strong>
     <input type="text" id="name" class="form-control" value=" {{ $storage->minimum_stock_level }}" readonly>
 </div>

 <div class="col-md-4 form-group">
     <strong>Maximum Stock Level:</strong>
     <input type="text" id="name" class="form-control" value=" {{ $storage->maximum_stock_level }}" readonly>
 </div>
