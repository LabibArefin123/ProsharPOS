<div class="col-md-4 form-group">
    ...
    <input type="text" id="name" class="form-control" value="{{ $storage->product->name }}" readonly>
</div>

<div class="col-md-4 form-group">
    <strong>SKU:</strong>
    <input type="text" id="name" class="form-control" value="{{ $storage->product->sku }}" readonly>
</div>
