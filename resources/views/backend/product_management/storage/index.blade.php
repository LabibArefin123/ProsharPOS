                    ...
                    <tbody>
                        @forelse ($storages as $store)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset($store->image_path ?? 'images/default.jpg') }}"
                                        alt="{{ $store->name }}" class="img-thumbnail" style="width: 60px; height: 60px;">
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ route('storages.destroy', $store->id) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
