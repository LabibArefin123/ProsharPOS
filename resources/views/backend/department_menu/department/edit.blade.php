        ...
        <div class="card-body">
            ...
            <form action="{{ route('departments.update', $department->id) }}" method="POST" data-confirm="edit">
                ...
                <div class="row">
                    ...
                    {{-- Division --}}
                    <div class="col-md-6 form-group">
                        <label for="division_id"><strong>Division Name</strong> <span class="text-danger">*</span></label>
                    ...
                    {{-- Department Code --}}
                    <div class="col-md-6 form-group">
                        <label for="dept_code"><strong>Department Code</strong> <span class="text-danger">*</span></label>
