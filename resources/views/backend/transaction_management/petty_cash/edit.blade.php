...
@section('content')
    <div class="card shadow-lg">
        <div class="card-body">
            ...
            <form action="{{ route('petty_cashes.update', $petty_cash->id) }}" method="POST" enctype="multipart/form-data"
                ...
                @include('backend.transaction_management.petty_cash.partial_edit.modal.file')
    ...
    <script src="{{ asset('js/backend/transaction_management/petty_cash/edit_page/pdf_confirm.js') }}"></script> {{-- Confirm PDF Load JS --}}
@stop
