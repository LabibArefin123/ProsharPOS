document.addEventListener("DOMContentLoaded", function () {
    ...
    /* ============================================================
       WARRANTY OPTIONS
    ============================================================ */
    function getWarrantyOptions(selectedId = "") {
    ...
    function renderCart() {
        ...
        cartItems.forEach((item, index) => {
            totalQty += parseInt(item.challan_total);
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" min="0"
                            value="${item.challan_bill}"
                            class="form-control form-control-sm bill-qty"
                            data-index="${index}">
                    </td>

                    <td>
                        <input type="number" min="0"
                            value="${item.challan_unbill}"
                            class="form-control form-control-sm unbill-qty"
                            data-index="${index}">
                    </td>

                    <td>
                        <input type="number" min="0"
                            value="${item.challan_foc}"
                    ...
                    <td>
                        <select class="form-control form-control-sm warranty-select"
                            data-index="${index}">
                            ${getWarrantyOptions(item.warranty_id)}
                        </select>
                    </td>
    ...
    /* ============================================================
       GLOBAL EVENT DELEGATION (IMPORTANT FIX)
    ============================================================ */
    ...
    document.addEventListener("input", function (e) {
        ...
        if (e.target.classList.contains("warranty-select")) {
            cartItems[index].warranty_id = e.target.value;
        }
